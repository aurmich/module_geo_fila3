 ...
 * @method static Locality|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Locality> get()
 * @method static Locality create(array $attributes = [])
 * @method static Locality firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Locality where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Locality whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
