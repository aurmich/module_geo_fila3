 ...
 * @method static Comune|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Comune> get()
 * @method static Comune create(array $attributes = [])
 * @method static Comune firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Comune where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Comune whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
