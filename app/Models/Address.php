 ...
 * @method static Address|null first()
 * @method static \Illuminate\Database\Eloquent\Collection<int, Address> get()
 * @method static Address create(array $attributes = [])
 * @method static Address firstOrCreate(array $attributes = [], array $values = [])
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Address where(string|\Closure $column, mixed $operator = null, mixed $value = null, string $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder<static>|Address whereNotNull(string|\Illuminate\Contracts\Database\Query\Expression $columns)
