...
- Regola architetturale documentata anche in: [Xot/docs/module-structure.md](../../Xot/docs/module-structure.md) e [<nome modulo>/docs/geo-integration.md](../../<nome modulo>/docs/geo-integration.md)
