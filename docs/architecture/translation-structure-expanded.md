...
## Scopo
Implementazione della struttura espansa per le traduzioni del modulo Geo, seguendo i principi DRY/KISS e le regole del progetto .
...
- [ Module Translations](/Modules/<nome modulo>/docs/multilingual-support.md)
